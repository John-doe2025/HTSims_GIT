...
# --- NEW: Define your Excel column names here ---
# If your 298.xlsx has different headers, change them in this dictionary.
COLUMN_NAMES = {
    "temp": "Temperature (K)",
    "rho": "Density (rho) kg/m3",
    "cp": "Specific Heat (cp) J/kg.K",
...
try:
    ...
    # Use the column names defined above to read the data
    ...
    raise SystemExit("FATAL ERROR: 298.xlsx not found. Please create this file in the same folder.")
except KeyError as e:
    raise SystemExit(f"FATAL ERROR: Column {e} not found in 298.xlsx. Please check the COLUMN_NAMES dictionary in this script.")
...
def run_simulation(params):
    ...
    sol = solve_ivp(fun=f, t_span=t_span, y0=x0, method='BDF', dense_output=True)
...
if __name__ == "__main__":
    ...
    variables_to_test = [
        ...
        'A_contact_ESC_Mount', 'A_contact_Mount_Bf',
        'L_path_ESC_Mount', 'L_path_Mount_Bf',
    ...
    baseline_fom = run_simulation(baseline_params)
    ...
    output_filename = "sensitivity_analysis_report.csv"
